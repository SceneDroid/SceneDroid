...
import android.goal.explorer.analysis.value.values.fields.NullFieldValue;
import android.goal.explorer.analysis.value.values.path.NullPathValue;
import android.goal.explorer.analysis.value.values.path.PathValue;
...
public class PropagationValue implements BasePropagationValue, Internable<PropagationValue> {
  ...
  public BasePropagationValue joinWith(PropagationValue other) {
    if (this.pathValues.size() + other.pathValues.size() > PropagationConstants.VALUE_LIMIT) {
   ...
   * {@link android.goal.explorer.analysis.valueAnalysis.fields.values.IntermediateFieldValue} element.
   *
