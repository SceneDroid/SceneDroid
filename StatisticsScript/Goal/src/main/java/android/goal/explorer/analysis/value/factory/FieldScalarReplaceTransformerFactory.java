...
import android.goal.explorer.analysis.value.transformers.scalar.ScalarReplace;

public class FieldScalarReplaceTransformerFactory extends FieldTransformerFactory {

  @Override
  public FieldTransformer makeFieldTransformer(Object value) {
    return new ScalarReplace(value);
  }
