...
import android.goal.explorer.analysis.value.values.propagation.BottomPropagationValue;
 ...
 */
public class PropagationLattice implements MeetLattice<BasePropagationValue> {
  @Override
  ...
  @Override
  public BasePropagationValue meet(BasePropagationValue left, BasePropagationValue right) {
